...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.download'
        db.add_column('docviewer_document', 'download', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Document.related_url'
        db.add_column('docviewer_document', 'related_url', self.gf('django.db.models.fields.URLField')(max_length=1024, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.download'
        db.delete_column('docviewer_document', 'download')

        # Deleting field 'Document.related_url'
        db.delete_column('docviewer_document', 'related_url')
